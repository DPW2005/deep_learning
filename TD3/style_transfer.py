...
if __name__ == "__main__":
    ...
    show_image(keras.preprocessing.image.img_to_array(Image.open('content.jpg').resize((512, 512))), 'Content Image')
    show_image(keras.preprocessing.image.img_to_array(Image.open('style.jpg').resize((512, 512))), 'Style Image')
